...
class template1Style {
    ...
    public function dynamicCss($layout_id = 0)
    {
        ...
        ?>
       <style>
        .shopglut-ordercomplete.template1 * {
            margin: 0;
            padding: 0;
            box-sizing: border-box;
        }

        .shopglut-ordercomplete.template1 body {
        ...
        .shopglut-ordercomplete.template1 .container {
        ...
        .shopglut-ordercomplete.template1 .header {
        ...
        .shopglut-ordercomplete.template1 .success-icon {
        ...
        .shopglut-ordercomplete.template1 .header h1 {
        ...
        .shopglut-ordercomplete.template1 .header p {
        ...
        .shopglut-ordercomplete.template1 .content {
            padding: 0;
        }

        .shopglut-ordercomplete.template1 .order-summary {
        ...
        .shopglut-ordercomplete.template1 .order-header {
            display: flex;
        ...
        .shopglut-ordercomplete.template1 .order-details {
            display: grid;
        ...
        .shopglut-ordercomplete.template1 .detail-item {
            background: white;
            padding: 15px;
            border-radius: 5px;
            border: 1px solid <?php echo esc_attr($settings['order_summary_border_color']); ?>;
        ...
        .shopglut-ordercomplete.template1 .detail-label {
        ...
        .shopglut-ordercomplete.template1 .detail-value {
            font-weight: bold;
            color: <?php echo esc_attr($settings['detail_value_color']); ?>;
        }

        .shopglut-ordercomplete.template1 .order-items {
            background: white;
            border: 1px solid <?php echo esc_attr($settings['order_summary_border_color']); ?>;
            border-radius: 5px;
            overflow: hidden;
        ...
        .shopglut-ordercomplete.template1 .items-header {
            background-color: <?php echo esc_attr($settings['order_summary_background_color']); ?>;
            padding: 12px 15px;
            font-weight: bold;
        ...
        .shopglut-ordercomplete.template1 .item-name {
            font-weight: bold;
            margin-bottom: 3px;
        ...
        .shopglut-ordercomplete.template1 .total-row {
            display: flex;
            justify-content: space-between;
            margin-bottom: <?php echo esc_attr($settings['total_row_spacing']); ?>px;
        }

        .shopglut-ordercomplete.template1 .total-row span:first-child {
            color: <?php echo esc_attr($settings['total_row_label_color']); ?>;
            font-size: <?php echo esc_attr($settings['total_row_font_size']); ?>px;
        }

        .shopglut-ordercomplete.template1 .total-row span:last-child {
            color: <?php echo esc_attr($settings['total_row_value_color']); ?>;
            font-size: <?php echo esc_attr($settings['total_row_font_size']); ?>px;
        }

        .shopglut-ordercomplete.template1 .total-row.grand-total span:first-child {
        ...
        .shopglut-ordercomplete.template1 .total-row.grand-total span:last-child {
            color: <?php echo esc_attr($settings['grand_total_value_color']); ?>;
            font-size: <?php echo esc_attr($settings['grand_total_font_size']); ?>px;
            font-weight: <?php echo esc_attr($settings['grand_total_font_weight']); ?>;
        }

        .shopglut-ordercomplete.template1 .total-row.grand-total {
            margin-bottom: 0;
            padding-top: 10px;
            border-top: 1px solid <?php echo esc_attr($settings['total_section_border_color']); ?>;
        }

        .shopglut-ordercomplete.template1 .address-section {
            margin-top: <?php echo esc_attr($settings['section_spacing']); ?>px;
        }

        .shopglut-ordercomplete.template1 .address-grid {
            display: grid;
            grid-template-columns: repeat(auto-fit, minmax(300px, 1fr));
            gap: <?php echo esc_attr($settings['address_grid_gap']); ?>px;
        }

        .shopglut-ordercomplete.template1 .address-card {
        ...
        .shopglut-ordercomplete.template1 .address-header {
        ...
        .shopglut-ordercomplete.template1 .address-content {
        ...
        .shopglut-ordercomplete.template1 .address-content p {
            margin-bottom: 5px;
        }

        .shopglut-ordercomplete.template1 .address-content strong {
            color: <?php echo esc_attr($settings['address_header_color']); ?>;
        }

        .shopglut-ordercomplete.template1 .shipping-note {
            margin-top: 10px;
            padding: 8px;
        ...
        .shopglut-ordercomplete.template1 .actions {
            display: flex;
        ...
        .shopglut-ordercomplete.template1 .btn {
            flex: 1;
            min-width: 180px;
        ...
        .shopglut-ordercomplete.template1 .btn-primary {
        ...
        .shopglut-ordercomplete.template1 .btn-primary:hover {
            background-color: <?php echo esc_attr($settings['track_order_button_hover_background']); ?>;
        }

        .shopglut-ordercomplete.template1 .btn-secondary {
        ...
        .shopglut-ordercomplete.template1 .btn-secondary:hover {
            background-color: <?php echo esc_attr($settings['continue_shopping_button_hover_background']); ?>;
        }

        .shopglut-ordercomplete.template1 .footer {
            text-align: center;
        ...
        .shopglut-ordercomplete.template1 .footer p {
            margin-bottom: 10px;
        }
