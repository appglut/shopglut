...
$SHOPG_ordercomplete_STYLING = "shopg_ordercomplete_settings_template1";

// Live Preview Section
AGSHOPGLUT::createMetabox(
	'shopg_ordercomplete_live_preview',
	array(
		'title' => __( 'Preview -  Demo Mode', 'shopglut' ),
		'post_type' => 'ordercomplete',
		'context' => 'normal',
	)
);
...
AGSHOPGLUT::createSection(
    ...
    array(
        'fields' => array(
            array(
                'id' => 'ordercomplete-page-settings',
                'type' => 'tabbed',
                ...
                'tabs' => array(
                    ...
                    array(
                        ...
                        'fields' => array(
                            array(
                                'id' => 'override_woocommerce_ordercomplete',
                                'type' => 'switcher',
