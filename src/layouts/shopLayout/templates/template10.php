...
<div class="product-design product-template10" <?php if (!empty($product_id)): ?>
                ...
                <div class="product-cart-action">
                    ...
                    <a href="#" data-product-id="<?php echo esc_attr($product_id); ?>"
                        ...
                        <span>
                            ...
                            <span class="cart-added" style="display: none;"><i class="fa fa-check-square"></i> <?php echo esc_html__(' View cart', 'shopglut'); ?></span>
                            <span class=" cart-unavailable" style="display: none;"><i class="fa fa-shopping-cart"></i>
