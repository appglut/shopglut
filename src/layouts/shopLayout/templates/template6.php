...
// phpcs:ignore WordPress.DB.DirectDatabaseQuery.DirectQuery,WordPress.DB.DirectDatabaseQuery.NoCaching
		...
		<div class="product-design product-template6" <?php if ( ! empty( $product_id ) ) : ?>
            ...
            <a href="<?php echo esc_url($product_link); ?>"
                ...
                <?php endif;?>
               <div class="pri-img" style="background-image: url('<?php echo esc_url( $product_image ); ?>');"></div>
            ...
            <div class="product-badge">
				...
				<?php if ( $is_out_of_stock ) : ?>
					<span class="outofstock-badge product-label"><?php echo esc_html__( 'Out of Stock', 'shopglut' ); ?></span>
				<?php endif; ?>
				<?php if ( $is_featured ) : ?>
				...
				<?php endif; ?>
                        ...
                        data-product-id="<?php echo esc_attr( $product_id ); ?>"
									title="Add To Compare"><i class="fa fa-refresh"></i></a>
							</div>
							<div class="quickview-section ">
								<a class="quick-view" title="Quick View" href="#" data-product-id="<?php echo esc_attr( $product_id ); ?>"><i
					...
					<div class="product-caption product-identity">
						<h3 class="product-title"><a href="<?php echo esc_url( $product_link ); ?>"><?php echo esc_html( $product_name ); ?></a></h3>
						<span class="product-category"><?php echo esc_html__('Category', 'shopglut'); ?>: <?php foreach ( $categories as $index => $category_name ) : ?>
                ...
                <div class="product-cart-action">
                    <?php if ( $product_type === 'simple' ) : ?>
									...
									<?php elseif ( $product_type === 'external' ) : ?>
										<a href="<?php echo esc_url( $product->get_product_url() ); ?>" class="external-product btn btn-cart"
											target="_blank">
											<span class="cart-title">
												<i class="fa fa-external-link"></i><?php echo esc_html__( ' External Product', 'shopglut' ); ?>
											</span>
										</a>
 ...
 <?php if ( $wishlist_options['wishlist-require-login'] == true && ! is_user_logged_in() ) : ?>
										href="<?php echo esc_url( wp_login_url( site_url( isset( $_SERVER['REQUEST_URI'] ) ? sanitize_text_field( wp_unslash( $_SERVER['REQUEST_URI'] ) ) : '' ) ) ); ?>" <?php else : ?> class="wishlist" href="#"
										data-product-id="<?php echo esc_attr( $product_id ); ?>" <?php endif; ?>>
									<?php if ( $wishlist_options['wishlist-require-login'] == true && ! is_user_logged_in() ) : ?>
										<div class="locked">
