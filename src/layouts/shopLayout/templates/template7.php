...
// phpcs:ignore WordPress.DB.DirectDatabaseQuery.DirectQuery,WordPress.DB.DirectDatabaseQuery.NoCaching -- Direct query required for custom table operation
		...
		<div class="product-design product-template7" <?php if ( ! empty( $product_id ) ) : ?>
				data-product-id="<?php echo esc_attr( $product_id ); ?>" <?php endif; ?> 		<?php if ( ! empty( $category_ids ) ) : ?>
				data-product-category="<?php echo esc_attr( $category_ids ); ?>" <?php endif; ?> 		<?php if ( ! empty( $tag_ids ) ) : ?> data-product-tags="<?php echo esc_attr( $tag_ids ); ?>" <?php endif; ?> 		<?php if ( ! empty( $product_type ) ) : ?> data-product-type="<?php echo esc_attr( $product_type ); ?>" <?php endif; ?>>
				...
				<div class="product-item">
					...
					<div class="product-caption product-identity">
						<h3 class="product-title"><a
								href="<?php echo esc_url( $product_link ); ?>"><?php echo esc_html( $product_name ); ?></a></h3>
						<span class="product-category"><?php echo esc_html__( 'Category', 'shopglut' ); ?>:
						...
						<p class="price-box"> <span class="product-price">
						...
						<p class="cta-description"><?php echo esc_html( $product_description ); ?></p>
						<div class="cta-actions">
							...
							<div class="product-cart-action">
										...
										<a href="#" data-product-id="<?php echo esc_attr( $product_id ); ?>"
											...
											<span>
												...
												<span class="cart-added" style="display: none;">
													...
													<?php echo esc_html__( ' View cart', 'shopglut' ); ?>
												</span>
								...
								<?php elseif ( $product_type === 'variable' ) : ?>
									<a href="<?php echo esc_url( $product_link ); ?>" class="variable-product btn btn-cart">
										<span class="cart-title">
											<i
												class="fa-solid fa-sitemap"></i><?php echo esc_html__( ' Variable Product', 'shopglut' ); ?>
										</span>
									</a>
								<?php else : ?>
							...
							<div class="shopg-wishlist-section">
								<a title="Wishlist" <?php if ( $wishlist_options['wishlist-require-login'] == true && ! is_user_logged_in() ) : ?>
										...
										class="wishlist" href="#" data-product-id="<?php echo esc_attr( $product_id ); ?>" <?php endif; ?>>
									...
									<?php else : ?>
										<?php if ( in_array( $product_id, $wishlist_product_ids ) ) : ?>
											<div class="added">
												...
												<?php echo esc_html__( 'Wishlist', 'shopglut' ); ?>
											</div>
										<?php else : ?>
											<div class="not-added">
					...
					<div class="product-thumb">
						<?php if ( isset( $template_data['shopg_options_settings']['shopg_settings_options']['shopg_style_settings_accordion']['image-link-option'] ) && $template_data['shopg_options_settings']['shopg_settings_options']['shopg_style_settings_accordion']['image-link-option'] === 'enable' ) : ?>
							<a href="<?php echo esc_url( $product_link ); ?>" <?php if ( isset( $template_data['shopg_options_settings']['shopg_settings_options']['shopg_style_settings_accordion']['image-product-open-newtab'] ) && $template_data['shopg_options_settings']['shopg_settings_options']['shopg_style_settings_accordion']['image-product-open-newtab'] === '1' ) : ?> target="_blank" <?php endif; ?>>
							<?php endif; ?>
							<div class="pri-img" style="background-image: url('<?php echo esc_url( $product_image ); ?>');">
							</div>
						...
						<div class="product-badge">
							...
							<?php if ( $is_featured ) : ?>
								<span
									class="featured-badge product-label"><?php echo esc_html__( 'Featured', 'shopglut' ); ?></span>
							<?php endif; ?>
						...
						<div class="button-group">
							...
							<div class="quickview-section ">
								<a class="quick-view" title="Quick View" href="#"
									data-product-id="<?php echo esc_attr( $product_id ); ?>"><i
