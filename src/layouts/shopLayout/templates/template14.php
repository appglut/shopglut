<?php namespace Shopglut\layouts\shopLayout\templates;
...
class template14 {
	...
	public function layout_render($template_data) {
		...
		// Use caching for wishlist queries
		$cache_key = 'shopglut_wishlist_' . $user_id;
		$results = wp_cache_get( $cache_key, 'shopglut_wishlist' );

		if ( false === $results ) {
			// Use proper table identifier escaping with caching
			...
			// Cache for 5 minutes
			wp_cache_set( $cache_key, $results, 'shopglut_wishlist', 300 );
		}
...
<div class="product-design product-template14" <?php if (!empty($product_id)): ?>
        ...
        <div class="product-thumb">
            ...
            <div class="product-identity">
                <p class="product-category">
					...
					<div class="ratings">
						<?php for ( $i = 1; $i <= 5; $i++ ) : ?>
							<i class="fa <?php echo $i <= $average_rating ? 'fa-solid fa-star' : 'fa-regular fa-star'; ?>"></i>
						<?php endfor; ?>
					</div>
				</div>
				<div class="price-box">
            ...
            <div class="button-group">
                    ...
                    <div class="shopg-compare-section"> 
                        <a href="#" class="compare"
                            data-product-id="<?php echo esc_attr($product_id); ?>" title="Add To Compare">
