<?php
/**
 * Single Product template5 Specific Settings
 *
 * This file contains settings specifically designed for template5 single product layout.
 * template5 features:
...
$SHOPG_singleproduct_STYLING = "shopg_singleproduct_settings_template5";
...
AGSHOPGLUT::createMetabox(
    ...
    array(
        'title' => esc_html__('template5 Single Product Settings', 'shopglut'),
        'post_type' => 'singleproduct',
        'context' => 'side',
    )
);
...
$all_fields1 = array(
    ...
    array(
            ...
            array(
                ...
                'type' => 'tabbed',
                'title' => __('template5 Configuration', 'shopglut'),
                'tabs' => array(
