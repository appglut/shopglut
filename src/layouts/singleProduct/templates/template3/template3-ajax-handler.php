...
class template3_Variable_Product_Handler {

    public static function init() {
        // Register AJAX handlers only when template3 is active
        add_action('wp_ajax_shopglut_template3_add_variable_to_cart', array(__CLASS__, 'handle_variable_add_to_cart'));
        add_action('wp_ajax_nopriv_shopglut_template3_add_variable_to_cart', array(__CLASS__, 'handle_variable_add_to_cart'));

        // Enable WooCommerce AJAX for single product pages when using template3
...
template3_Variable_Product_Handler::init();