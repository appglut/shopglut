<?php
/**
 * Single Product template7 Specific Settings
 *
 * This file contains settings specifically designed for template7 single product layout.
 * template7 features:
...
$SHOPG_singleproduct_STYLING = "shopg_singleproduct_settings_template7";
...
AGSHOPGLUT::createMetabox(
    ...
    array(
        'title' => esc_html__('template7 Single Product Settings', 'shopglut'),
        'post_type' => 'singleproduct',
        'context' => 'side',
    )
);
...
$all_fields1 = array(
    ...
    array(
            ...
            array(
                ...
                'type' => 'tabbed',
                'title' => __('template7 Configuration', 'shopglut'),
                'tabs' => array(
