<?php
/**
 * Single Product template6 Specific Settings
 *
 * This file contains settings specifically designed for template6 single product layout.
 * template6 features:
...
$SHOPG_singleproduct_STYLING = "shopg_singleproduct_settings_template6";
...
AGSHOPGLUT::createMetabox(
    ...
    array(
        'title' => esc_html__('template6 Single Product Settings', 'shopglut'),
        'post_type' => 'singleproduct',
        'context' => 'side',
    )
);
...
$all_fields1 = array(
    ...
    array(
            ...
            array(
                ...
                'type' => 'tabbed',
                'title' => __('template6 Configuration', 'shopglut'),
                'tabs' => array(
