...
// phpcs:ignore WordPress.DB.DirectDatabaseQuery.DirectQuery,WordPress.DB.DirectDatabaseQuery.NoCaching
    ...
    public static function retrieveAll($limit = 0, $current_page = 1) {
        ...
        $cache_key = 'shopglut_single_product_layouts_all_' . md5( $limit . '_' . $current_page );
        $result = wp_cache_get( $cache_key );

        if ( false === $result ) {
            // Build query with proper table name placeholder
    ...
    public static function retrieveAllCount() {
        ...
        $cache_key = 'shopglut_single_product_layouts_count';
...
// phpcs:ignore WordPress.DB.DirectDatabaseQuery.DirectQuery,WordPress.DB.DirectDatabaseQuery.NoCaching
        ...
        if ( $result ) {
            wp_cache_delete( 'shopglut_single_product_layouts_count' );
    ...
    public static function verifyTable() {
        ...
        $cache_key = 'shopglut_table_exists_single_product_layout';
