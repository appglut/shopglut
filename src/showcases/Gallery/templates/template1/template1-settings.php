<?php
/**
 * Shop Gallery Template1 Specific Settings
 *
 * This file contains settings specifically designed for Template1 Shop Gallery layout.
 * Template1 features:
 * - Gallery content (title, description, image, button)
 * - Display settings (pages, positions, timing)
 * - Modal styling and appearance
 * - Gallery behavior and triggers
 */
...
$SHOPG_GALLERY_STYLING = "shopg_product_gallery_settings_template1";

// Live Preview Section
AGSHOPGLUT::createMetabox(
	'shopg_product_gallery_live_preview',
	array(
...
// Main Gallery Styling Settings
AGSHOPGLUT::createMetabox(
    $SHOPG_GALLERY_STYLING,
    array(
        'title' => esc_html__('Template1 Shop Gallery Settings', 'shopglut'),
        'post_type' => 'product_gallery',
        'context' => 'side',
    )
);
    ...
    array(
        'fields' => array(
            ...
            array(
                'id' => 'enable_gallery',
                'type' => 'switcher',
                'title' => __('Enable Shop Gallery', 'shopglut'),
                'desc' => __('Enable or disable the Shop Gallery feature', 'shopglut'),
                'default' => true,
            ),
            ...
            array(
                ...
                'type' => 'select_gallery_pages',
                'title' => __('Display Shop Gallery On', 'shopglut'),
                'desc' => __('Select pages where the Shop Gallery should appear. Each location can only be used by one layout.', 'shopglut'),
                'options' => 'select_gallery_pages',
                'multiple' => true,
                'chosen' => true,
                'placeholder' => __('Select pages to show Shop Gallery', 'shopglut'),
                'dependency' => array('enable_gallery', '==', true),

            ),

            // Organized Settings in Tabs
            array(
                'id' => 'gallery_settings_tabs',
                'type' => 'tabbed',
                'title' => __('Shop Gallery Settings', 'shopglut'),
                'dependency' => array('enable_gallery', '==', true),
                'tabs' => array(
                    ...
                    array(
                        ...
                        'fields' => array(
                            ...
                            array(
                                'id' => 'gallery_title',
                                'type' => 'text',
                                'title' => __('Gallery Title', 'shopglut'),
                                'desc' => __('Enter the main title for your gallery', 'shopglut'),
                            ...
                            array(
                                ...
                                'type' => 'textarea',
                                'title' => __('Gallery Description', 'shopglut'),
                                'desc' => __('Enter the description text for your gallery', 'shopglut'),
                            ...
                            array(
                                'id' => 'gallery_image',
                                'type' => 'media',
                                'title' => __('Gallery Image', 'shopglut'),
                                'desc' => __('Upload an image for your gallery (optional)', 'shopglut'),
                                'library' => 'image',
                                'url' => false,
                            ),
                    ...
                    array(
                        ...
                        'fields' => array(
                            ...
                            array(
                                ...
                                'desc' => __('Time in milliseconds before the gallery appears on page load', 'shopglut'),
                                'unit' => 'ms',
                                'min' => 0,
                                'max' => 10000,
                                'step' => 500,
                            ...
                            array(
                                'id' => 'gallery_position',
                                'type' => 'select',
                                'title' => __('Gallery Position', 'shopglut'),
                                'desc' => __('Where the gallery should appear on the screen', 'shopglut'),
                                'options' => array(
                            ...
                            array(
                                ...
                                'desc' => __('Only show the gallery once per user session', 'shopglut'),
                                'default' => false,
                            ),
                        ),
                    ),
                    ...
                    array(
                        ...
                        'fields' => array(
                            ...
                            // Gallery Appearance
                            array(
                                'id' => 'gallery_appearance',
                                'type' => 'fieldset',
                                'title' => __('Gallery Appearance', 'shopglut'),
                                'fields' => array(
                                    array(
