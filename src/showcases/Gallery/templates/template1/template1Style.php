...
class template1Style {
    ...
    public function dynamicCss($layout_id = 0)
    {
       ...
       <style>
        /* ===== RESET & BASE STYLES ===== */
        .shopglut-product-gallery.template1 * {
            margin: 0;
            padding: 0;
        ...
        .shopglut-product-gallery.template1 .gallery-modal.active {
            opacity: 1;
            visibility: visible;
        }

        .shopglut-product-gallery.template1 .gallery-modal-overlay {
            position: absolute;
            top: 0;
            left: 0;
            right: 0;
        ...
        .shopglut-product-gallery.template1 .gallery-modal.active .gallery-modal-content {
            transform: scale(1);
        }

        /* ===== CLOSE BUTTON ===== */
        .shopglut-product-gallery.template1 .gallery-close {
            position: absolute;
            top: 15px;
            right: 15px;
        ...
        .shopglut-product-gallery.template1 .gallery-close:hover {
        ...
        .shopglut-product-gallery.template1 .gallery-close svg {
        ...
        /* ===== PRODUCT GALLERY ===== */
        .shopglut-product-gallery.template1 .gallery-gallery {
            display: flex;
            flex-direction: column;
            gap: 15px;
        }

        .shopglut-product-gallery.template1 .main-image-wrapper {
            position: relative;
            width: 100%;
            aspect-ratio: 1 / 1;
        ...
        .shopglut-product-gallery.template1 .gallery-main-image {
            width: 100%;
            height: 100%;
            object-fit: cover;
            transition: transform 0.3s ease;
        ...
        .shopglut-product-gallery.template1 .main-image-wrapper:hover .gallery-main-image {
            transform: scale(1.05);
        }

        .shopglut-product-gallery.template1 .sale-badge {
            position: absolute;
            top: 15px;
            left: 15px;
        ...
        /* ===== GALLERY THUMBNAILS ===== */
        .shopglut-product-gallery.template1 .gallery-thumbnails {
        ...
        .shopglut-product-gallery.template1 .gallery-thumbnails::-webkit-scrollbar {
            height: 6px;
        }

        .shopglut-product-gallery.template1 .gallery-thumbnails::-webkit-scrollbar-track {
            background: #f1f1f1;
            border-radius: 3px;
        }

        .shopglut-product-gallery.template1 .gallery-thumbnails::-webkit-scrollbar-thumb {
            background: #d1d5db;
            border-radius: 3px;
        }

        .shopglut-product-gallery.template1 .thumbnail-item {
            flex-shrink: 0;
        ...
        .shopglut-product-gallery.template1 .thumbnail-item:hover {
            border-color: #9ca3af;
        }

        .shopglut-product-gallery.template1 .thumbnail-item.active {
        ...
        .shopglut-product-gallery.template1 .thumbnail-item img {
            width: 100%;
            height: 100%;
            object-fit: cover;
        }
        ...
        /* ===== PRODUCT INFO ===== */
        .shopglut-product-gallery.template1 .gallery-info {
            display: flex;
            flex-direction: column;
            gap: 20px;
        }
        ...
        /* ===== PRODUCT TITLE ===== */
        .shopglut-product-gallery.template1 .product-title {
        ...
        /* ===== PRODUCT RATING ===== */
        .shopglut-product-gallery.template1 .product-rating {
        ...
        .shopglut-product-gallery.template1 .stars {
            display: flex;
            gap: 2px;
        }

        .shopglut-product-gallery.template1 .star {
            font-size: <?php echo esc_attr($settings['star_size'] ?? 18); ?>px;
            color: #d1d5db;
        }

        .shopglut-product-gallery.template1 .star-full {
            color: <?php echo esc_attr($settings['star_color'] ?? '#fbbf24'); ?>;
        }

        .shopglut-product-gallery.template1 .star-half {
            color: <?php echo esc_attr($settings['star_color'] ?? '#fbbf24'); ?>;
            opacity: 0.5;
        }

        .shopglut-product-gallery.template1 .rating-text {
            font-size: 14px;
            color: <?php echo esc_attr($settings['rating_text_color'] ?? '#6b7280'); ?>;
        }

        /* ===== PRODUCT PRICE ===== */
        .shopglut-product-gallery.template1 .product-price {
            display: flex;
            align-items: baseline;
            gap: 12px;
        }

        .shopglut-product-gallery.template1 .sale-price,
        .shopglut-product-gallery.template1 .current-price {
            font-size: <?php echo esc_attr($settings['price_font_size'] ?? 32); ?>px;
            font-weight: 700;
            color: <?php echo esc_attr($settings['price_color'] ?? '#111827'); ?>;
        }

        .shopglut-product-gallery.template1 .regular-price {
            font-size: 20px;
            color: <?php echo esc_attr($settings['regular_price_color'] ?? '#9ca3af'); ?>;
        }

        .shopglut-product-gallery.template1 .regular-price del {
            text-decoration: line-through;
        }

        /* ===== PRODUCT DESCRIPTION ===== */
        .shopglut-product-gallery.template1 .product-description {
        ...
        .shopglut-product-gallery.template1 .product-description p {
            margin: 0 0 10px 0;
        }

        .shopglut-product-gallery.template1 .product-description p:last-child {
            margin-bottom: 0;
        }

        /* ===== PRODUCT META ===== */
        .shopglut-product-gallery.template1 .product-meta {
            display: flex;
            flex-direction: column;
            gap: 8px;
            padding: 15px;
        ...
        .shopglut-product-gallery.template1 .meta-item {
            display: flex;
            gap: 8px;
            font-size: 14px;
        }

        .shopglut-product-gallery.template1 .meta-label {
            font-weight: 600;
            color: <?php echo esc_attr($settings['meta_label_color'] ?? '#374151'); ?>;
            min-width: 100px;
        }

        .shopglut-product-gallery.template1 .meta-value {
            color: <?php echo esc_attr($settings['meta_value_color'] ?? '#6b7280'); ?>;
        }

        .shopglut-product-gallery.template1 .meta-value a {
            color: #667eea;
            text-decoration: none;
        }

        .shopglut-product-gallery.template1 .meta-value a:hover {
            text-decoration: underline;
        }

        .shopglut-product-gallery.template1 .stock-status {
            font-weight: 600;
        }

        .shopglut-product-gallery.template1 .stock-status.in-stock {
            color: <?php echo esc_attr($settings['in_stock_color'] ?? '#10b981'); ?>;
        }

        .shopglut-product-gallery.template1 .stock-status.out-of-stock {
            color: <?php echo esc_attr($settings['out_of_stock_color'] ?? '#ef4444'); ?>;
        }

        /* ===== PRODUCT VARIATIONS ===== */
        .shopglut-product-gallery.template1 .product-variations {
            display: flex;
            flex-direction: column;
            gap: 15px;
            padding: 15px 0;
        ...
        .shopglut-product-gallery.template1 .variation-item {
            display: flex;
            flex-direction: column;
            gap: 8px;
        }

        .shopglut-product-gallery.template1 .variation-label {
        ...
        .shopglut-product-gallery.template1 .variation-select {
            width: 100%;
        ...
        .shopglut-product-gallery.template1 .variation-select:hover {
            border-color: <?php
        ...
        .shopglut-product-gallery.template1 .variation-select:focus {
            outline: none;
        ...
        .shopglut-product-gallery.template1 .variation-select:disabled {
            opacity: 0.6;
            cursor: not-allowed;
        ...
        .shopglut-product-gallery.template1 .variation-select option {
            padding: 10px;
            color: <?php echo esc_attr($settings['variation_select_text_color'] ?? '#374151'); ?>;
            background-color: <?php echo esc_attr($settings['variation_select_bg'] ?? '#ffffff'); ?>;
        }

        .shopglut-product-gallery.template1 .variation-select option:disabled {
            color: #9ca3af;
        }

        .shopglut-product-gallery.template1 .variation-select option:checked {
            background-color: <?php echo esc_attr($settings['variation_select_focus_border'] ?? '#667eea'); ?>;
            color: #ffffff;
        }

        /* ===== PRODUCT ACTIONS ===== */
        .shopglut-product-gallery.template1 .product-actions {
            display: flex;
            gap: 12px;
            margin-top: 10px;
        }

        .shopglut-product-gallery.template1 .quantity-selector {
            display: flex;
            align-items: center;
        ...
        .shopglut-product-gallery.template1 .qty-btn {
            width: 44px;
            height: 50px;
        ...
        .shopglut-product-gallery.template1 .qty-btn:hover {
            background: <?php echo esc_attr($settings['qty_button_hover_bg'] ?? '#e5e7eb'); ?>;
        }

        .shopglut-product-gallery.template1 .qty-input {
            width: 60px;
            height: 50px;
            border: none;
        ...
        .shopglut-product-gallery.template1 .qty-input::-webkit-outer-spin-button,
        .shopglut-product-gallery.template1 .qty-input::-webkit-inner-spin-button {
            -webkit-appearance: none;
            margin: 0;
        }

        .shopglut-product-gallery.template1 .qty-input:focus {
            outline: none;
        }

        .shopglut-product-gallery.template1 .add-to-cart-btn {
            flex: 1;
            height: 50px;
        ...
        .shopglut-product-gallery.template1 .add-to-cart-btn:hover {
            background: <?php echo esc_attr($settings['cart_button_hover_bg'] ?? '#5a67d8'); ?>;
            transform: translateY(-1px);
            box-shadow: 0 4px 12px rgba(102, 126, 234, 0.3);
        }

        .shopglut-product-gallery.template1 .add-to-cart-btn:active {
            transform: translateY(0);
        }

        /* ===== ADDITIONAL ACTIONS ===== */
        .shopglut-product-gallery.template1 .additional-actions {
            display: flex;
            gap: 10px;
        }

        .shopglut-product-gallery.template1 .view-details-btn {
            display: inline-flex;
            align-items: center;
            justify-content: center;
            padding: 12px 24px;
        ...
        .shopglut-product-gallery.template1 .view-details-btn:hover {
            background: <?php echo esc_attr($settings['details_button_hover_bg'] ?? '#e5e7eb'); ?>;
            border-color: #9ca3af;
        }

        /* ===== ERROR STATE ===== */
        .shopglut-gallery-error {
            padding: 40px;
            text-align: center;
            background: #fef2f2;
        ...
        /* ===== UTILITY CLASSES ===== */
        .shopglut-product-gallery.template1 .hidden {
            display: none !important;
        }

        /* ===== LOADING STATE ===== */
        .shopglut-product-gallery.template1 .loading {
            pointer-events: none;
            opacity: 0.6;
        }

        .shopglut-product-gallery.template1 .loading::after {
            content: '';
            position: absolute;
            top: 50%;
            left: 50%;
        ...
        /* ===== ACCESSIBILITY ===== */
        .shopglut-product-gallery.template1 *:focus-visible {
    ...
    private function getLayoutSettings($layout_id) {
        ...
        $layout_data = $wpdb->get_row(
            $wpdb->prepare(sprintf("SELECT layout_settings FROM `%s` WHERE id = %d", esc_sql($table_name)), $layout_id) // phpcs:ignore WordPress.DB.PreparedSQLPlaceholders.ReplacementsWrongNumber -- Using sprintf for table name escaping
        );

        if ($layout_data && !empty($layout_data->layout_settings)) {
            $settings = maybe_unserialize($layout_data->layout_settings);
            if (isset($settings['shopg_product_gallery_settings_template1']['product_gallery-page-settings'])) {
                return $this->flattenSettings($settings['shopg_product_gallery_settings_template1']['product_gallery-page-settings']);
            }
        }
