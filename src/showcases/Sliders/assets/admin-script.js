/**
 * ShopGlut Product Slider - Admin JavaScript
 * Handles Live View Demo modal functionality in admin area
 */
(function($) {
    'use strict';

    const ShopGlutSliderAdmin = {
        /**
        ...
        bindEvents: function() {
            ...
            $(document).on('click', '.slider-close, .slider-modal-overlay, .shopglut-template-modal-close-modal', function(e) {
                e.preventDefault();
                self.closeSlider();
            });

            // Prevent modal content click from closing modal
            $(document).on('click', '.slider-modal-content, .shopglut-template-modal-modal-content', function(e) {
                e.stopPropagation();
            });
        ...
        closeSlider: function() {
            ...
            // Handle standard slider modal structure
    ...
    $(document).ready(function() {
        ShopGlutSliderAdmin.init();

        // Expose to global window object for other modules
        window.ShopGlutSliderAdmin = ShopGlutSliderAdmin;
    });
