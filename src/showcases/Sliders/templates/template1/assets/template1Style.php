...
class template1Style {
	...
	public function dynamicCss($layout_id) {
		...
		$custom_css = "
/* ShopGlut Product Slider Template1 - WooCommerce Product Carousel */
...
.shopglut-product-slider.template1 .product-slider-container {
	width: 100%;
}
...
.shopglut-product-slider.template1 .slider-controls {
	display: flex;
	gap: 12px;
}
...
.shopglut-product-slider.template1 .product-slider-wrapper {
	display: flex;
...
.shopglut-product-slider.template1 .product-slide .product-card {
	height: 100%;
	display: flex;
...
.shopglut-product-slider.template1 .product-card:hover .product-img {
	transform: scale(1.05);
}

/* Badges */
.shopglut-product-slider.template1 .sale-badge,
.shopglut-product-slider.template1 .out-of-stock-badge {
	position: absolute;
	top: 16px;
	left: 16px;
	padding: 6px 12px;
...
.shopglut-product-slider.template1 .product-card:hover .product-actions {
	opacity: 1;
	transform: translateX(0);
}

.shopglut-product-slider.template1 .action-btn {
	display: flex;
	align-items: center;
	justify-content: center;
	width: 40px;
...
.shopglut-product-slider.template1 .action-btn:hover {
	background: #ffffff;
	color: #007bff;
	transform: scale(1.1);
...
.shopglut-product-slider.template1 .action-btn.add-to-cart-btn {
	color: #28a745;
}

.shopglut-product-slider.template1 .action-btn.add-to-cart-btn:hover {
	background: #28a745;
	color: #ffffff;
}
...
.shopglut-product-slider.template1 .star-rating {
	color: #ffc107;
}
...
/* Product SKU */
.shopglut-product-slider.template1 .product-sku {
	display: flex;
	align-items: center;
	gap: 4px;
	font-size: 12px;
...
.shopglut-product-slider.template1 .sku-label {
	font-weight: 500;
}
...
.shopglut-product-slider.template1 .dot-item::before {
	content: '';
	position: absolute;
	top: 50%;
	left: 50%;
...
.shopglut-product-slider.template1 .dot-item.active::before {
	width: 12px;
	height: 12px;
}

/* Demo Mode Styles */
.shopglut-product-slider-demo-container {
	max-width: 1200px;
	margin: 0 auto;
	padding: 20px;
	background: #f8f9fa;
...
.shopglut-product-slider-demo-container .demo-header {
	text-align: center;
	margin-bottom: 30px;
}

.shopglut-product-slider-demo-container .demo-header h3 {
	font-size: 28px;
	font-weight: 600;
	color: #2c3e50;
	margin-bottom: 10px;
...
.shopglut-product-slider-demo-container .demo-header p {
	font-size: 16px;
	color: #6c757d;
	line-height: 1.6;
}

.shopglut-product-slider.template1.demo-mode {
...
/* Loading States */
.shopglut-product-slider.template1 .product-slide.loading {
...
/* Accessibility */
.shopglut-product-slider.template1 .slider-nav:focus,
.shopglut-product-slider.template1 .action-btn:focus,
.shopglut-product-slider.template1 .dot-item:focus {
	outline: 3px solid #007cba;
	outline-offset: 2px;
}

.shopglut-product-slider.template1 .product-name a:focus {
...
/* RTL Support */
.rtl .shopglut-product-slider.template1 .slider-nav svg {
	transform: scaleX(-1);
}

.rtl .shopglut-product-slider.template1 .product-actions {
	left: 16px;
	right: auto;
	transform: translateX(-10px);
}

.rtl .shopglut-product-slider.template1 .product-card:hover .product-actions {
	transform: translateX(0);
}
";
