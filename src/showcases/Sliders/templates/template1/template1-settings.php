<?php
/**
 * Shop Slider Template1 Specific Settings
 *
 * This file contains settings specifically designed for Template1 Shop Slider layout.
 * Template1 features:
 * - Slider content (title, description, image, button)
 * - Display settings (pages, positions, timing)
 * - Modal styling and appearance
 * - Slider behavior and triggers
 */
...
$SHOPG_SLIDER_STYLING = "shopg_product_slider_settings_template1";

// Live Preview Section
AGSHOPGLUT::createMetabox(
	'shopg_product_slider_live_preview',
	array(
...
// Main Slider Styling Settings
AGSHOPGLUT::createMetabox(
    $SHOPG_SLIDER_STYLING,
    array(
        'title' => esc_html__('Template1 Shop Slider Settings', 'shopglut'),
        'post_type' => 'product_slider',
        'context' => 'side',
    )
);
    ...
    array(
        'fields' => array(
            ...
            array(
                'id' => 'enable_slider',
                'type' => 'switcher',
                'title' => __('Enable Shop Slider', 'shopglut'),
                'desc' => __('Enable or disable the Shop Slider feature', 'shopglut'),
                'default' => true,
            ),
            ...
            array(
                ...
                'type' => 'select_slider_pages',
                'title' => __('Display Shop Slider On', 'shopglut'),
                'desc' => __('Select pages where the Shop Slider should appear. Each location can only be used by one layout.', 'shopglut'),
                'options' => 'select_slider_pages',
                'multiple' => true,
                'chosen' => true,
                'placeholder' => __('Select pages to show Shop Slider', 'shopglut'),
                'dependency' => array('enable_slider', '==', true),

            ),

            // Organized Settings in Tabs
            array(
                'id' => 'slider_settings_tabs',
                'type' => 'tabbed',
                'title' => __('Shop Slider Settings', 'shopglut'),
                'dependency' => array('enable_slider', '==', true),
                'tabs' => array(
                    ...
                    array(
                        ...
                        'fields' => array(
                            ...
                            array(
                                'id' => 'slider_title',
                                'type' => 'text',
                                'title' => __('Slider Title', 'shopglut'),
                                'desc' => __('Enter the main title for your slider', 'shopglut'),
                            ...
                            array(
                                ...
                                'type' => 'textarea',
                                'title' => __('Slider Description', 'shopglut'),
                                'desc' => __('Enter the description text for your slider', 'shopglut'),
                            ...
                            array(
                                'id' => 'slider_image',
                                'type' => 'media',
                                'title' => __('Slider Image', 'shopglut'),
                                'desc' => __('Upload an image for your slider (optional)', 'shopglut'),
                                'library' => 'image',
                                'url' => false,
                            ),
                    ...
                    array(
                        ...
                        'fields' => array(
                            ...
                            array(
                                ...
                                'desc' => __('Time in milliseconds before the slider appears on page load', 'shopglut'),
                                'unit' => 'ms',
                                'min' => 0,
                                'max' => 10000,
                                'step' => 500,
                            ...
                            array(
                                'id' => 'slider_position',
                                'type' => 'select',
                                'title' => __('Slider Position', 'shopglut'),
                                'desc' => __('Where the slider should appear on the screen', 'shopglut'),
                                'options' => array(
                            ...
                            array(
                                ...
                                'desc' => __('Only show the slider once per user session', 'shopglut'),
                                'default' => false,
                            ),
                        ),
                    ),
                    ...
                    array(
                        ...
                        'fields' => array(
                            ...
                            // Slider Appearance
                            array(
                                'id' => 'slider_appearance',
                                'type' => 'fieldset',
                                'title' => __('Slider Appearance', 'shopglut'),
                                'fields' => array(
                                    array(
