/**
 * ShopGlut Product ShopBanner - Admin JavaScript
 * Handles Live View Demo modal functionality in admin area
 */
(function($) {
    'use strict';

    const ShopGlutShopBannerAdmin = {
        /**
         * Initialize Admin ShopBanner
         */
        init: function() {
            this.bindEvents();
        },
        ...
        bindEvents: function() {
            ...
            $(document).on('click', '.shopbanner-close, .shopbanner-modal-overlay, .shopglut-template-modal-close-modal', function(e) {
                e.preventDefault();
                self.closeShopBanner();
            });

            // Prevent modal content click from closing modal
            $(document).on('click', '.shopbanner-modal-content, .shopglut-template-modal-modal-content', function(e) {
                e.stopPropagation();
            });
        ...
        closeShopBanner: function() {
            ...
            // Handle standard shopbanner modal structure
    ...
    $(document).ready(function() {
        ShopGlutShopBannerAdmin.init();

        // Expose to global window object for other modules
        window.ShopGlutShopBannerAdmin = ShopGlutShopBannerAdmin;
    });
