/**
 * ShopGlut Product Tab - Admin JavaScript
 * Handles Live View Demo modal functionality in admin area
 */
(function($) {
    'use strict';

    const ShopGlutTabAdmin = {
        /**
        ...
        bindEvents: function() {
            ...
            $(document).on('click', '.tab-close, .tab-modal-overlay, .shopglut-template-modal-close-modal', function(e) {
                e.preventDefault();
                self.closeTab();
            });

            // Prevent modal content click from closing modal
            $(document).on('click', '.tab-modal-content, .shopglut-template-modal-modal-content', function(e) {
                e.stopPropagation();
            });
        ...
        closeTab: function() {
            ...
            // Handle standard tab modal structure
    ...
    $(document).ready(function() {
        ShopGlutTabAdmin.init();

        // Expose to global window object for other modules
        window.ShopGlutTabAdmin = ShopGlutTabAdmin;
    });
