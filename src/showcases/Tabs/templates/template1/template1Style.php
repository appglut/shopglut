...
class template1Style {
    ...
    public function dynamicCss($layout_id = 0)
    {
       ...
       <style>
        ...
        /* ===== MODAL OVERLAY ===== */
        .shopglut-product-tab.template1 .tab-modal {
            position: fixed;
            top: 0;
            left: 0;
            right: 0;
        ...
        .shopglut-product-tab.template1 .tab-modal.active {
            opacity: 1;
            visibility: visible;
        }

        .shopglut-product-tab.template1 .tab-modal-overlay {
            position: absolute;
            top: 0;
            left: 0;
            right: 0;
        ...
        /* ===== MODAL CONTENT ===== */
        .shopglut-product-tab.template1 .tab-modal-content {
            position: relative;
        ...
        .shopglut-product-tab.template1 .tab-modal.active .tab-modal-content {
            transform: scale(1);
        }

        /* ===== CLOSE BUTTON ===== */
        .shopglut-product-tab.template1 .tab-close {
            position: absolute;
            top: 15px;
            right: 15px;
        ...
        .shopglut-product-tab.template1 .tab-close:hover {
        ...
        /* ===== PRODUCT GALLERY ===== */
        .shopglut-product-tab.template1 .tab-gallery {
            display: flex;
            flex-direction: column;
            gap: 15px;
        }

        .shopglut-product-tab.template1 .main-image-wrapper {
            position: relative;
            width: 100%;
            aspect-ratio: 1 / 1;
        ...
        .shopglut-product-tab.template1 .tab-main-image {
            width: 100%;
            height: 100%;
            object-fit: cover;
            transition: transform 0.3s ease;
        ...
        .shopglut-product-tab.template1 .main-image-wrapper:hover .tab-main-image {
        ...
        /* ===== GALLERY THUMBNAILS ===== */
        .shopglut-product-tab.template1 .gallery-thumbnails {
        ...
        .shopglut-product-tab.template1 .gallery-thumbnails::-webkit-scrollbar {
            height: 6px;
        }

        .shopglut-product-tab.template1 .gallery-thumbnails::-webkit-scrollbar-track {
            background: #f1f1f1;
            border-radius: 3px;
        }

        .shopglut-product-tab.template1 .gallery-thumbnails::-webkit-scrollbar-thumb {
            background: #d1d5db;
            border-radius: 3px;
        }

        .shopglut-product-tab.template1 .thumbnail-item {
            flex-shrink: 0;
        ...
        .shopglut-product-tab.template1 .thumbnail-item:hover {
            border-color: #9ca3af;
        }

        .shopglut-product-tab.template1 .thumbnail-item.active {
        ...
        .shopglut-product-tab.template1 .thumbnail-item img {
            width: 100%;
            height: 100%;
            object-fit: cover;
        }
        ...
        /* ===== PRODUCT INFO ===== */
        .shopglut-product-tab.template1 .tab-info {
            display: flex;
            flex-direction: column;
            gap: 20px;
        }
        ...
        /* ===== PRODUCT TITLE ===== */
        .shopglut-product-tab.template1 .product-title {
        ...
        .shopglut-product-tab.template1 .stars {
            display: flex;
            gap: 2px;
        }

        .shopglut-product-tab.template1 .star {
            font-size: <?php echo esc_attr($settings['star_size'] ?? 18); ?>px;
            color: #d1d5db;
        }

        .shopglut-product-tab.template1 .star-full {
            color: <?php echo esc_attr($settings['star_color'] ?? '#fbbf24'); ?>;
        }

        .shopglut-product-tab.template1 .star-half {
            color: <?php echo esc_attr($settings['star_color'] ?? '#fbbf24'); ?>;
            opacity: 0.5;
        }

        .shopglut-product-tab.template1 .rating-text {
            font-size: 14px;
        ...
        .shopglut-product-tab.template1 .current-price {
        ...
        .shopglut-product-tab.template1 .regular-price del {
            text-decoration: line-through;
        }

        /* ===== PRODUCT DESCRIPTION ===== */
        .shopglut-product-tab.template1 .product-description {
        ...
        .shopglut-product-tab.template1 .product-description p {
            margin: 0 0 10px 0;
        }

        .shopglut-product-tab.template1 .product-description p:last-child {
            margin-bottom: 0;
        }

        /* ===== PRODUCT META ===== */
        .shopglut-product-tab.template1 .product-meta {
            display: flex;
            flex-direction: column;
            gap: 8px;
            padding: 15px;
        ...
        .shopglut-product-tab.template1 .meta-item {
            display: flex;
            gap: 8px;
            font-size: 14px;
        }

        .shopglut-product-tab.template1 .meta-label {
            font-weight: 600;
            color: <?php echo esc_attr($settings['meta_label_color'] ?? '#374151'); ?>;
            min-width: 100px;
        }

        .shopglut-product-tab.template1 .meta-value {
            color: <?php echo esc_attr($settings['meta_value_color'] ?? '#6b7280'); ?>;
        }

        .shopglut-product-tab.template1 .meta-value a {
            color: #667eea;
            text-decoration: none;
        }

        .shopglut-product-tab.template1 .meta-value a:hover {
            text-decoration: underline;
        }

        .shopglut-product-tab.template1 .stock-status {
            font-weight: 600;
        }

        .shopglut-product-tab.template1 .stock-status.in-stock {
            color: <?php echo esc_attr($settings['in_stock_color'] ?? '#10b981'); ?>;
        }

        .shopglut-product-tab.template1 .stock-status.out-of-stock {
            color: <?php echo esc_attr($settings['out_of_stock_color'] ?? '#ef4444'); ?>;
        }

        /* ===== PRODUCT VARIATIONS ===== */
        .shopglut-product-tab.template1 .product-variations {
            display: flex;
            flex-direction: column;
            gap: 15px;
            padding: 15px 0;
        ...
        .shopglut-product-tab.template1 .variation-item {
            display: flex;
            flex-direction: column;
            gap: 8px;
        }

        .shopglut-product-tab.template1 .variation-label {
        ...
        .shopglut-product-tab.template1 .variation-select {
            width: 100%;
        ...
        .shopglut-product-tab.template1 .variation-select:hover {
            border-color: <?php
        ...
        .shopglut-product-tab.template1 .variation-select:focus {
            outline: none;
        ...
        .shopglut-product-tab.template1 .variation-select:disabled {
            opacity: 0.6;
            cursor: not-allowed;
        ...
        .shopglut-product-tab.template1 .variation-select option {
            padding: 10px;
            color: <?php echo esc_attr($settings['variation_select_text_color'] ?? '#374151'); ?>;
            background-color: <?php echo esc_attr($settings['variation_select_bg'] ?? '#ffffff'); ?>;
        }

        .shopglut-product-tab.template1 .variation-select option:disabled {
            color: #9ca3af;
        }

        .shopglut-product-tab.template1 .variation-select option:checked {
        ...
        .shopglut-product-tab.template1 .quantity-selector {
            display: flex;
            align-items: center;
        ...
        .shopglut-product-tab.template1 .qty-btn {
            width: 44px;
            height: 50px;
        ...
        .shopglut-product-tab.template1 .qty-btn:hover {
            background: <?php echo esc_attr($settings['qty_button_hover_bg'] ?? '#e5e7eb'); ?>;
        }

        .shopglut-product-tab.template1 .qty-input {
            width: 60px;
            height: 50px;
            border: none;
        ...
        .shopglut-product-tab.template1 .qty-input::-webkit-outer-spin-button,
        .shopglut-product-tab.template1 .qty-input::-webkit-inner-spin-button {
            -webkit-appearance: none;
            margin: 0;
        }

        .shopglut-product-tab.template1 .qty-input:focus {
            outline: none;
        }

        .shopglut-product-tab.template1 .add-to-cart-btn {
            flex: 1;
            height: 50px;
        ...
        .shopglut-product-tab.template1 .add-to-cart-btn:hover {
            background: <?php echo esc_attr($settings['cart_button_hover_bg'] ?? '#5a67d8'); ?>;
            transform: translateY(-1px);
            box-shadow: 0 4px 12px rgba(102, 126, 234, 0.3);
        }

        .shopglut-product-tab.template1 .add-to-cart-btn:active {
            transform: translateY(0);
        }

        /* ===== ADDITIONAL ACTIONS ===== */
        .shopglut-product-tab.template1 .additional-actions {
            display: flex;
            gap: 10px;
        }

        .shopglut-product-tab.template1 .view-details-btn {
            display: inline-flex;
            align-items: center;
            justify-content: center;
            padding: 12px 24px;
        ...
        .shopglut-product-tab.template1 .view-details-btn:hover {
        ...
        /* ===== UTILITY CLASSES ===== */
        .shopglut-product-tab.template1 .hidden {
            display: none !important;
        }

        /* ===== LOADING STATE ===== */
        .shopglut-product-tab.template1 .loading {
            pointer-events: none;
            opacity: 0.6;
        }

        .shopglut-product-tab.template1 .loading::after {
            content: '';
            position: absolute;
            top: 50%;
            left: 50%;
        ...
        /* ===== ACCESSIBILITY ===== */
        .shopglut-product-tab.template1 *:focus-visible {
    ...
    private function getLayoutSettings($layout_id) {
        ...
        $layout_data = $wpdb->get_row(
            $wpdb->prepare("SELECT layout_settings FROM `{$wpdb->prefix}shopglut_tab_layouts` WHERE id = %d", $layout_id)
        );

        if ($layout_data && !empty($layout_data->layout_settings)) {
            $settings = maybe_unserialize($layout_data->layout_settings);
            if (isset($settings['shopg_product_tab_settings_template1']['product_tab-page-settings'])) {
                return $this->flattenSettings($settings['shopg_product_tab_settings_template1']['product_tab-page-settings']);
            }
        }
