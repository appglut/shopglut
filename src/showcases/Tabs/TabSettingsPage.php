...
class TabSettingsPage {

	public $menu_slug = 'product_tab';

	public function __construct() {

	}

	public function loadTabEditor() {
...
$layout_data = $wpdb->get_row( // phpcs:ignore WordPress.DB.DirectDatabaseQuery.DirectQuery,WordPress.DB.DirectDatabaseQuery.NoCaching -- Direct query required for custom table operation
	    ...
	    <form id="shopglut_shop_layouts" method="post" action="">
				...
				<?php 
				$shopg_cpage_nonce = wp_create_nonce( 'shopg_Tab_layouts' ); 
				?>
				<input type="hidden" name="shopg_Tab_layouts_nonce" value="<?php echo esc_attr( $shopg_cpage_nonce ); ?>">
			   ...
			   <div id="post-body" class="metabox-holder columns-2">
						...
						<div id="shopg-Tab-layout-settings" class="postbox-container shopg-layout-settings-wrapper">
						...
						<div class="submitbox" id="submitpost">
								<div id="TabLayout-publishing-action" class="shopg-publishing-button">
									<button type="button" id="Tab-reset-settings-button" class="btn btn-fullwidth btn-secondary"
									style=" background: #dc3545; color: white; border: none;">
									<?php echo esc_attr__( 'Reset', 'shopglut' ); ?>
									</button>
									<button type="button" name="publish" id="Tab-save-layout-button" class="btn btn-fullwidth">
						...
						<div id="shopg-Tab-layout-container" class="shopg-admin-edit-panel shopg-layout-container">
		...
		<style>
			...
			/* When loader is visible, prevent interaction with tab demo */
			.loader-overlay:not([style*="display: none"]) ~ * .shopglut-product-tab {
